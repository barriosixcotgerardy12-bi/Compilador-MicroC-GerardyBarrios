...
El primer autómata identifica palabras reservadas e identificadores. Tiene 3 estados: q0 es el estado inicial. Cuando lee una letra o guion bajo, transiciona a q1. En q1 sigue leyendo letras, dígitos o guion bajo — se mantiene en q1. Cuando encuentra otro carácter diferente, transiciona a q2 que es el estado de aceptación. Al terminar, consulta el diccionario de UnidadesLexicas. Si la palabra es int, devuelve Token 17. Si es main, devuelve Token 300 porque es un identificador.
...
El tercer autómata maneja los comentarios. Tiene 6 estados: q0 lee la diagonal. En q1 decide: si encuentra otra diagonal es comentario de línea — q2. Si encuentra asterisco es comentario de bloque — q3. Si encuentra otro carácter es simplemente el operador de división — q6. En q2 ignora todo hasta encontrar salto de línea. En q3 busca el cierre asterisco-diagonal. Cuando lo encuentra en q4 y q5, el comentario termina
